  ...
  ({
    ...
    const fetchSummonerSpellName = async (
      ...
      try {
        ...
        const spell = spellsArray.find((spell) => {
          if (spell.key === summonerSpell.toString()) {
            return spell.id;
          }
        });
    ...
    return (
      <div className="flex flex-col w-3/4 mx-auto ">
        <div
          className={`flex flex-col sm:w-full justify-center sm:flex-row gap-4 sm:gap-10 bg-blue-5 dark:bg-bluedark-5 p-4 mx-auto rounded-lg  ${
            displayTeamMates ? 'rounded-b-none' : 'rounded-lg'
          } ${
            victory
        ...
        >
          <div className="flex flex-col sm:flex-row items-center gap-8 sm:gap-4 w-full justify-between">
            <div className="flex items-center">
              <p
                className={`first-letter:text-4xl w-[24px]   ${
                  victory
            ...
            <div className="relative flex items-center my-auto">
              <img
                ...
                title={championName}
              />
              <span className="absolute rounded-full px-2 py-1 bg-graydark-2 text-graydark-12 top-full right-0 translate-x-1/2 -translate-y-1/2 lg:-translate-y-1/2">
                {level}
              </span>
            </div>
            <div className="flex justify-between gap-8 xl:w-[357px]">
